package com.esidev.deepfake.ml;
...
public final class ModelTflite {
  @NonNull
  private final Model model;

  private ModelTflite(@NonNull Context context, @NonNull Model.Options options) throws IOException {
    model = Model.createModel(context, "model_tflite.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static ModelTflite newInstance(@NonNull Context context) throws IOException {
    return new ModelTflite(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static ModelTflite newInstance(@NonNull Context context, @NonNull Model.Options options)
      throws IOException {
    return new ModelTflite(context, options);
  }
