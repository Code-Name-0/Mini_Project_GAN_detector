...
public final class Generator {
  ...
  private Generator(@NonNull Context context, @NonNull Model.Options options) throws IOException {
    model = Model.createModel(context, "generator.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static Generator newInstance(@NonNull Context context) throws IOException {
    return new Generator(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static Generator newInstance(@NonNull Context context, @NonNull Model.Options options)
      throws IOException {
    return new Generator(context, options);
  }
